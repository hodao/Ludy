            ...
            <section class="relative pt-24 pb-36 bg-white overflow-hidden">
                <img class="absolute bottom-0 left-1/2 transform -translate-x-1/2" src="flaro-assets/images/contact/gradient.svg" alt=""/>
                    <div class="relative z-10 container px-4 mx-auto">
                        <h2 class="mb-5 text-6xl md:text-6xl font-bold font-heading text-center tracking-px-n leading-tight">Get connected</h2>
                        <p class="mb-20 text-lg text-gray-600 text-center font-medium leading-normal md:max-w-lg mx-auto">We would love to hear from you!</p>
